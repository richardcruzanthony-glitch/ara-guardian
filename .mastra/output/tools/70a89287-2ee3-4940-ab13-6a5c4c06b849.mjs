...
function calculateQuote(material, quantity, dimensions) {
  ...
  const volumeDiscount = quantity >= 100 ? 0.15 : quantity >= 50 ? 0.1 : quantity >= 25 ? 0.05 : 0;
...
const guardianQuoteTool = createTool({
  id: "guardian-quote",
  ...
  execute: async ({ context, mastra }) => {
    ...
    logger?.info("\u{1F4B0} [GuardianQuote] Processing quote request:", context.request);
    try {
      ...
      const formatted = `
\u{1F3ED} GUARDIAN SENTINEL QUOTE
\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501
...
`.trim();
      logger?.info("\u{1F4B0} [GuardianQuote] Quote generated:", quote.totalPrice);
      return {
        success: true,
        quote,
        formatted
      ...
      logger?.error("\u{1F4B0} [GuardianQuote] Error:", e);
      return {
        success: false,
...
const listMaterialsTool = createTool({
  id: "list-materials",
  ...
  execute: async ({ mastra }) => {
    const logger = mastra?.getLogger();
    logger?.info("\u{1F4CB} [ListMaterials] Listing available materials");
...
export { guardianQuoteTool, listMaterialsTool };
